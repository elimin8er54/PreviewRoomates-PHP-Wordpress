      ...
      <?php if ( ! $_print_header_img ) : ?>
              <div class="group pad central-header-zone">
				  ...
				  <?php if(isset($_SESSION['roommate_user_id'])) { ?>
					Welcome, <?php echo $_SESSION['roommate_user_name'] . " "; ?> <a class="main_logout" href="#">Logout</a>
				  <?php } else { ?>
				  <a style = "float:left;" class = "button-action button-signin" href="<?php echo get_permalink( get_page_by_path( 'login' ) ); ?>">Login</a>
					<a style="float:left;margin-left:10px;" class = "button-action" href="<?php echo get_permalink( get_page_by_path( 'register' ) ); ?>">Register</a> 
