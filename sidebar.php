...
<?php if ( $layout != 'col-1c'): ?>
	...
	<div class="sidebar s1 collapsed" style = "margin-top:<?php echo hu_get_option('sidebars'); ?>px" data-position="<?php echo hu_get_sidebar_position( 's1' ); ?>" data-layout="<?php echo $layout ?>" data-sb-id="s1">
...
<div class = "top-info" style = "margin-top:-<?php echo hu_get_option('top-info'); ?>px">
	<?php echo hu_get_option('top-left-title'); ?>
	<div class = "bottom-info">
<?php echo hu_get_option('top-left-desc'); ?>
