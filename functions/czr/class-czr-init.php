    ...
    class HU_customize {
        ...
        */
        ...
        function hu_register_partials( WP_Customize_Manager $wp_customize ) {
			...
			$wp_customize->selective_refresh->add_partial( 's1', array(
                'selector' => '.s1',
                'settings' => array( 'hu_theme_options[sidebars]' ),
                'render_callback' => '',
            ) );
			
            $wp_customize->selective_refresh->add_partial( 'top-left-title', array(
                'selector' => '.top-info',
                'settings' => array( 'hu_theme_options[top-left-title]' ),
                'render_callback' => '',
            ) );
			
			$wp_customize->selective_refresh->add_partial( 'top-left-desc', array(
                'selector' => '.bottom-info',
                'settings' => array( 'hu_theme_options[top-left-desc]' ),
                'render_callback' => '',
            ) );
