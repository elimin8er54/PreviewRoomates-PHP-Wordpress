    ...
    ******************************************************************************************************/
    ...
    function hu_general_design_sec( $get_default = null ) {
      return array(
		  ...
		  'top-left-title'  =>  array(
                'default'       => 'ROOMMATES',
                'control'       => 'HU_controls' ,
                'label'         => __( "Top left corner title" , 'hueman' ),
                'section'       => 'general_design_sec' ,
                'type'          => 'text' ,
                'step'          => 1,
               'transport' => hu_is_partial_refreshed_on() ? 'postMessage' : 'refresh',
				'sanitize_callback' => array( $this, 'hu_sanitize_html_text_input' ),
                'notice'        => __('', 'hueman')//@todo sprintf and split translations
          ),
		  'top-left-desc'  =>  array(
                'default'       => 'Search by people who enjoy the same things you do! ',
                'control'       => 'HU_controls' ,
                'sanitize_callback' => array( $this, 'hu_sanitize_html_text_input' ),
                'label'         => __( "Top left description" , 'hueman' ),
                'section'       => 'general_design_sec' ,
                'type'          => 'text' ,
                'step'          => 1,
                //'transport'     => 'postMessage',
		  ...
		  'top-right-title'  =>  array(
                'default'       => 'Rooms 4 rent',
                'control'       => 'HU_controls' ,
                'sanitize_callback' => array( $this, 'hu_sanitize_html_text_input' ),
                'label'         => __( "Top right title" , 'hueman' ),
                'section'       => 'general_design_sec' ,
                'type'          => 'text' ,
                'step'          => 1,
		  ...
		  'top-right-desc'  =>  array(
                'default'       => 'Find your Room for Rent Today!',
                'control'       => 'HU_controls' ,
                'sanitize_callback' => array( $this, 'hu_sanitize_html_text_input' ),
                'label'         => __( "Top right description" , 'hueman' ),
                'section'       => 'general_design_sec' ,
                'type'          => 'text' ,
                'step'          => 1,
                //'transport'     => 'postMessage',
		  ...
		  'top-info'  =>  array(
                ...
                'control'       => 'HU_controls' ,
                'sanitize_callback' => array( $this , 'hu_sanitize_number' ),
                'label'         => __( "Corner Vertical Alignment" , 'hueman' ),
                'section'       => 'general_design_sec' ,
                'type'          => 'number' ,
                'step'          => 1,
                //'transport'     => 'postMessage',
		  ...
		  'sidebars'  =>  array(
                ...
                'control'       => 'HU_controls' ,
                'sanitize_callback' => array( $this , 'hu_sanitize_html_text_input' ),
                'label'         => __( "Sidebar Vertical Alignment" , 'hueman' ),
                'section'       => 'general_design_sec' ,
                'type'          => 'text' ,
                'step'          => 1,
                //'transport'     => 'postMessage',
