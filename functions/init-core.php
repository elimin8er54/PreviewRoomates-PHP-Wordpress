...
//GET CURRENT THEMES DIRECTORY
if( ! defined( 'THEME_DIR' ) )      define( 'THEME_DIR' , get_theme_root_uri( get_template() ) ."/".get_template() );
 ...
 *  Database connection
/* ------------------------------------------------------------------------- */
load_template( get_template_directory() . '/functions/DbConnection.php' );

/* ------------------------------------------------------------------------- *
 *  Database connection
/* ------------------------------------------------------------------------- */
load_template( get_template_directory() . '/functions/database_connect.php' );
...
function hu_get_front_style_url() {
  return sprintf('%1$s/assets/front/css/%2$s%3$s.css?version=11',
