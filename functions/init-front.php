    ...
    function hu_print_logo_or_title( $echo = true, $is_mobile_menu = false ) {
        ...
        ob_start();
            ...
            if ( ! empty( $logo_or_title ) ) {
                ?>
                  <p class="site-title" id = "top-social" ><?php hu_do_render_logo_site_tite( $logo_or_title ) ?></p>
                <?php
            }
...
if ( ! function_exists( 'hu_scripts' ) ) {
  function hu_scripts() {
    ...
    wp_enqueue_script(
        'hu-front-scripts',
        sprintf('%1$s/assets/front/js/scripts%2$s.js' , get_template_directory_uri(), ( defined('WP_DEBUG') && true === WP_DEBUG ) ? '' : '' ),
